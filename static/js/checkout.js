        ...
        else
        {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var options = {
                        "key": "rzp_test_zbJVRNazzzDG54", // Enter the Key ID generated from the Dashboard
                        ...
                        "currency": "INR",
                        "name": "Mundo Airsoft", //your business name
                        ...
                        "handler": function (responseb){
                            ...
                            $.ajax({
                                ...
                                success: function (responsec) {
                                    swal("Felicidades!", responsec.status, "exito").then((value) => {
